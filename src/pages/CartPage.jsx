...
import { clearPizzas, removeCartItem, incrementCartItem, decrementCartItem } from '../redux/reducers/cart-reducer'
import { useDispatch } from 'react-redux'

export const CartPage = ({ addedPizzas, totalCount, totalPrice, cart_items }) => {
   ...
   const onIncrementItem = (itemId) => {
      dispatch(incrementCartItem(itemId))
   }
   const onDecrementItem = (itemId) => {
      dispatch(decrementCartItem(itemId))
   }
   const handleOnClickPay = () => {
      if (window.confirm('Вы действительно хотите сформировать заказ?')) {
         alert('Заказ успешно сформирован!\nОжидайте подтверджения от менеджера.')
            ...
            <div className="cart__body">
               <div className="cart__top top-cart">
                  <div className="top-cart__inner">
                     ...
                     <button onClick={handleClearPizzas} className="top-cart__clear">
               ...
               {addedPizzas.map(obj => (
                  <CartItem
                     ...
                     totalPrice={cart_items[obj.id].totalPrice}
                     totalCount={cart_items[obj.id].count}
               ...
               <div className="cart__actions actions-cart">
                  <div className="actions-cart__inner">
                     ...
                     <Link to={'/'}>
                        <Button onClickFn={handleOnClickPay} className="actions-cart__pay-btn pay-btn">
